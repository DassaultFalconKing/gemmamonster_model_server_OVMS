...
function Send-Probe($subdir, $choice) {
  $td = "$ev\$subdir"
...
Send-Probe "test-7a-real-exa-required" "required"
Send-Probe "test-7b-real-exa-named" ([ordered]@{ type = "function"; function = [ordered]@{ name = "exa_web_search_exa" } })
