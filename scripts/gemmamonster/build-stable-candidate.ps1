...
$dependencyPins = [ordered]@{
    ...
    XGRAMMAR_VERSION = [string]$profile.XGRAMMAR_VERSION
    XGRAMMAR_COMMIT = [string]$profile.XGRAMMAR_COMMIT
    XGRAMMAR_MAX_WHITESPACE_CNT = $profile.XGRAMMAR_MAX_WHITESPACE_CNT
