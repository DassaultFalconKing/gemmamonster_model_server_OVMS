...
Assert-ExactPin $pins 'XGRAMMAR_VERSION' ([string]$profile.XGRAMMAR_VERSION)
Assert-ExactPin $pins 'XGRAMMAR_COMMIT' ([string]$profile.XGRAMMAR_COMMIT)
Assert-ExactPin $pins 'XGRAMMAR_MAX_WHITESPACE_CNT' ([string]$profile.XGRAMMAR_MAX_WHITESPACE_CNT)
